...
describe('Validate JS configs', () => {
  it('Validate bncode-fe-eslint-config', async () => {
  ...
  it('Validate bncode-fe-eslint-config/es5', async () => {
  ...
  it('Validate bncode-fe-eslint-config/vue', async () => {
  ...
  it('Validate bncode-fe-eslint-config/essential', async () => {
  ...
  it('Validate bncode-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate bncode-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate bncode-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate bncode-fe-eslint-config/node', async () => {
