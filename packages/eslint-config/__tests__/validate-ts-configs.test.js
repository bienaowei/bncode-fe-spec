...
describe('Validate TS configs', () => {
  it('Validate bncode-fe-eslint-config/typescript', async () => {
  ...
  it('Validate bncode-fe-eslint-config/typescript/vue', async () => {
  ...
  it('Validate bncode-fe-eslint-config/essential/typescript', async () => {
  ...
  it('Validate bncode-fe-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate bncode-fe-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate bncode-fe-eslint-config/typescript/node', async () => {
